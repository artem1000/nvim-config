...
vim.keymap.set(
	"n",
	"<leader>os",
	':Telescope find_files search_dirs={"/Users/agrinchenko/Documents/Notes/Notes/notes"}<cr>'
)
vim.keymap.set(
	"n",
	"<leader>oz",
	':Telescope live_grep search_dirs={"/Users/agrinchenko/Documents/Notes/Notes/notes"}<cr>'
)
--
...
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /Users/agrinchenko/Documents/Notes/Notes/zettelkasten<cr>:bd<cr>")
